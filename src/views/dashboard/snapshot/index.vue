...
const load = async () => {
  loading.value = true;
  try {
    const r = await getDailySnapshots({ page: page.value, size: size.value, startDate: query.startDate || undefined, endDate: query.endDate || undefined });
  ...
  <div class="page-container">
    <div class="page-header">
      <el-form :model="query" inline>
        <el-form-item label="日期范围">
          <el-date-picker v-model="query.startDate" type="date" value-format="YYYY-MM-DD" placeholder="开始" style="width:140px" />
    ...
    <div class="page-table">
      <el-table v-loading="loading" :data="tableData" stripe style="width:100%">
        ...
        <el-table-column prop="sales_total" label="销售额" width="100" />
        <el-table-column prop="revenue_confirmed" label="确认收入" width="100" />
